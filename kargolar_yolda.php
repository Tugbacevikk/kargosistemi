...
$sorgu = $baglanti->prepare("SELECT * FROM kargolar WHERE kullanici_id = ? AND durum = 'Yolda' ORDER BY tarih DESC");
$sorgu->bind_param("i", $kullanici_id);
$sorgu->execute();
$sonuc = $sorgu->get_result();
?>

<h4>Yolda Olan Kargolar</h4>
        ...
        <tbody>
            <?php while ($kargo = $sonuc->fetch_assoc()): ?>
                <tr>
                    ...
                    <td><span class="badge bg-info">Yolda</span></td>
                    <td>
...
<?php else: ?>
    <div class="alert alert-info">Yolda olan kargo bulunamadı.</div>
<?php endif; ?>
