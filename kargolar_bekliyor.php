...
$sorgu = $baglanti->prepare("SELECT * FROM kargolar WHERE kullanici_id = ? AND durum = 'Bekliyor' ORDER BY tarih DESC");
$sorgu->bind_param("i", $kullanici_id);
$sorgu->execute();
$sonuc = $sorgu->get_result();
?>

<h4>Bekleyen Kargolar</h4>
...
<?php else: ?>
    <div class="alert alert-info">Bekleyen kargo bulunamadı.</div>
<?php endif; ?>
